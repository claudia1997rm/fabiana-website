...
export const siteImageGroups = [
  ...
  },
  {
    ...
    items: [
      { key: 'categoryHabits', label: 'Hábitos', fallback: categories[0].image },
      { key: 'categoryFashion', label: 'Moda', fallback: categories[1].image },
      { key: 'categoryBeauty', label: 'Estetica', fallback: categories[2].image },
      { key: 'categoryPhotography', label: 'Fotografía', fallback: categories[3].image },
      { key: 'categoryAstrology', label: 'Astrología', fallback: categories[4].image },
