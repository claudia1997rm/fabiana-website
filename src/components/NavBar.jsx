  ...
  return (
    <header className="sticky top-0 z-40 border-b border-plum/20 bg-lavenderMist/90 backdrop-blur-xl transition duration-500">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4 md:px-10">
        ...
        <div className="flex items-center gap-2 rounded-full border border-plum/20 bg-lavenderMist/75 px-2 py-1.5 text-[11px] uppercase tracking-[0.28em] backdrop-blur-md">
          {user ? (
            <>
            ...
            <>
              ...
              <Link className="rounded-full border border-plum/25 bg-lavenderMist/80 px-4 py-2 text-deepPlum transition duration-500 hover:-translate-y-0.5 hover:border-plum/30 hover:bg-plum hover:text-white hover:shadow-lavender focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-plum/25" to="/signup">Crear cuenta</Link>
            </>
          )}
        </div>
      </div>
