export function BrandLogo({ className = '' }) {
  return (
    <span
      aria-hidden="true"
      className={`inline-flex h-9 w-9 items-center justify-center rounded-full border border-plum/20 bg-plum text-white shadow-[0_10px_22px_rgba(91,74,120,0.16)] transition duration-500 group-hover:-translate-y-0.5 group-hover:border-plum/25 group-hover:bg-deepPlum ${className}`}
    >
