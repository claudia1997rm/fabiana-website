...
export function UniverseSection() {
  return (
    <section id="universo" className="section-shell border-y border-plum/25 bg-[linear-gradient(135deg,rgba(246,244,251,0.96),rgba(109,91,166,0.16))]">
          ...
          {categories.map((category, index) => {
            ...
            return (
              <Link
                ...
                className={`reveal-on-scroll group hover-lift relative block cursor-pointer overflow-hidden rounded-[2rem] border border-ink/10 p-7 transition duration-700 hover:border-plum/25 hover:shadow-lavender focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-plum/25 focus-visible:ring-offset-4 focus-visible:ring-offset-cloud md:p-8 ${featured ? 'bg-plum text-white lg:row-span-2' : 'bg-white/80 text-ink'}`}
