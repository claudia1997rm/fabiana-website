...
export function NewsletterSection() {
  return (
    <section id="newsletter" className="section-shell mx-auto max-w-6xl px-6 py-24 md:px-10 lg:py-32">
      <div className="reveal-on-scroll relative overflow-hidden rounded-[2.4rem] border border-ink/10 bg-[linear-gradient(135deg,rgba(255,255,255,0.95),rgba(236,228,219,0.85)_52%,rgba(220,199,192,0.72)_100%)] px-6 py-12 shadow-card transition duration-700 hover:-translate-y-1 hover:shadow-glow md:px-12 lg:px-16 lg:py-16">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-2.5">
              {['Notas privadas', 'Recursos seleccionados', 'Lanzamientos primero'].map((item) => (
                <span key={item} className="rounded-full border border-ink/10 bg-white/55 px-4 py-2 text-[10px] uppercase tracking-[0.26em] text-ink/60 backdrop-blur-sm">
                  {item}
                </span>
              ))}
            </div>
          ...
          <div className="glass-panel rounded-[1.9rem] p-5 shadow-soft transition duration-500 hover:-translate-y-1 hover:bg-white/60 md:p-6">
            <form className="flex flex-col gap-4">
              ...
              <input
                ...
                className="min-h-14 rounded-full border border-ink/12 bg-white/85 px-6 text-sm tracking-[0.06em] text-ink outline-none transition duration-300 placeholder:text-ink/35 focus:border-ink/50 focus:bg-white focus:shadow-soft"
              />
              <button
                type="submit"
                className="min-h-14 rounded-full border border-ink bg-ink px-8 text-[11px] font-semibold uppercase tracking-[0.34em] text-cloud transition duration-500 hover:-translate-y-1 hover:bg-white hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/25 focus-visible:ring-offset-4 focus-visible:ring-offset-cloud"
              >
