...
export function BlogPostDetailPage() {
  ...
  if (loading) return <section className="mx-auto max-w-7xl px-6 py-24 md:px-10">Cargando artículo...</section>;
  if (!post) return <section className="mx-auto max-w-7xl px-6 py-24 md:px-10">Artículo no encontrado.</section>;
