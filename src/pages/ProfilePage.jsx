    ...
    <section className="mx-auto max-w-5xl px-6 py-24 md:px-10">
      <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="magazine-frame rounded-[2rem] p-8">
          ...
          <p className="mt-5 leading-7 text-ink/70">Sesi?n iniciada como {user.email}.</p>
          ...
          <button onClick={signOut} className="ml-3 mt-8 rounded-full border border-ink/20 bg-white px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.32em] text-ink transition hover:border-ink/40">Cerrar sesi?n</button>
        </div>
        ...
        <form onSubmit={handleSave} className="magazine-frame rounded-[2rem] p-8">
          ...
          <label className="mt-6 flex items-start gap-3 rounded-[1.25rem] bg-white/60 p-4 text-sm leading-6 text-ink/70">
            ...
            Quiero recibir correos cuando Fabiana publique nuevos recursos o art?culos del diario.
          </label>
          ...
          <div className="mt-8 border-t border-ink/10 pt-6">
            ...
            <p className="mt-2 text-sm text-ink/60">Correo: {preferences.email ? 'activado' : 'desactivado'} - Notificaciones push: preparadas para m?s adelante</p>
