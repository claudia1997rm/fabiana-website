...
export function ResourceDetailPage() {
  ...
  if (loading) return <section className="mx-auto max-w-7xl px-6 py-24 md:px-10">Cargando recurso...</section>;
  if (!resource) return <section className="mx-auto max-w-7xl px-6 py-24 md:px-10">Recurso no encontrado.</section>;
